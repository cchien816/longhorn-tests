...
helm install longhorn oci://dp.apps.rancher.io/charts/longhorn --namespace longhorn-system
```
...
| Key | Type | Default | Description |
|-----|------|---------|-------------|
| image.csi.attacher.registry | string | `"dp.apps.rancher.io"` | Registry for the CSI attacher image |
| image.csi.attacher.repository | string | `"registry.suse.de/home/mbjoerkelund/orchid/containerfile/kubernetes-csi-external-attacher"` | Repository for the CSI attacher image. When unspecified, Longhorn uses the default value. |
| image.csi.attacher.tag | string | `"4.7.0"` | Tag for the CSI attacher image. When unspecified, Longhorn uses the default value. |
| image.csi.livenessProbe.registry | string | `"dp.apps.rancher.io"` | Registry for the CSI liveness probe image |
| image.csi.livenessProbe.repository | string | `"registry.suse.de/home/mbjoerkelund/orchid/containerfile/kubernetes-csi-livenessprobe"` | Repository for the CSI liveness probe image. When unspecified, Longhorn uses the default value. |
| image.csi.livenessProbe.tag | string | `"2.14.0"` | Tag for the CSI liveness probe image. When unspecified, Longhorn uses the default value. |
| image.csi.nodeDriverRegistrar.registry | string | `"dp.apps.rancher.io"` | Registry for the CSI Node Driver Registrar image |
| image.csi.nodeDriverRegistrar.repository | string | `"registry.suse.de/home/mbjoerkelund/orchid/containerfile/kubernetes-csi-node-driver-registrar"` | Repository for the CSI Node Driver Registrar image. When unspecified, Longhorn uses the default value. |
| image.csi.nodeDriverRegistrar.tag | string | `"2.12.0"` | Tag for the CSI Node Driver Registrar image. When unspecified, Longhorn uses the default value. |
| image.csi.provisioner.registry | string | `"dp.apps.rancher.io"` | Registry for the CSI Provisioner image |
| image.csi.provisioner.repository | string | `"registry.suse.de/home/mbjoerkelund/orchid/containerfile/kubernetes-csi-external-provisioner"` | Repository for the CSI Provisioner image. When unspecified, Longhorn uses the default value. |
| image.csi.provisioner.tag | string | `"5.1.0"` | Tag for the CSI Provisioner image. When unspecified, Longhorn uses the default value. |
| image.csi.resizer.registry | string | `"dp.apps.rancher.io"` | Registry for the CSI Resizer image |
| image.csi.resizer.repository | string | `"registry.suse.de/home/mbjoerkelund/orchid/containerfile/kubernetes-csi-external-resizer"` | Repository for the CSI Resizer image. When unspecified, Longhorn uses the default value. |
| image.csi.resizer.tag | string | `"1.12.0"` | Tag for the CSI Resizer image. When unspecified, Longhorn uses the default value. |
| image.csi.snapshotter.registry | string | `"dp.apps.rancher.io"` | Registry for the CSI Snapshotter image |
| image.csi.snapshotter.repository | string | `"registry.suse.de/home/mbjoerkelund/orchid/containerfile/kubernetes-csi-external-snapshotter"` | Repository for the CSI Snapshotter image. When unspecified, Longhorn uses the default value. |
| image.csi.snapshotter.tag | string | `"8.1.0"` | Tag for the CSI Snapshotter image. When unspecified, Longhorn uses the default value. |
| image.longhorn.backingImageManager.registry | string | `"dp.apps.rancher.io"` | Registry for the Backing Image Manager image |
| image.longhorn.backingImageManager.repository | string | `"registry.suse.de/home/mbjoerkelund/orchid/containerfile/longhorn-backing-image-manager"` | Repository for the Backing Image Manager image. When unspecified, Longhorn uses the default value. |
| image.longhorn.backingImageManager.tag | string | `"1.7.2"` | Tag for the Backing Image Manager image. When unspecified, Longhorn uses the default value. |
| image.longhorn.engine.registry | string | `"dp.apps.rancher.io"` | Registry for the Longhorn Engine image |
| image.longhorn.engine.repository | string | `"registry.suse.de/home/mbjoerkelund/orchid/containerfile/longhorn-engine"` | Repository for the Longhorn Engine image. |
| image.longhorn.engine.tag | string | `"1.7.2"` | Tag for the Longhorn Engine image. |
| image.longhorn.instanceManager.registry | string | `"dp.apps.rancher.io"` | Registry for the Longhorn Instance Manager image |
| image.longhorn.instanceManager.repository | string | `"registry.suse.de/home/mbjoerkelund/orchid/containerfile/longhorn-instance-manager"` | Repository for the Longhorn Instance Manager image. |
| image.longhorn.instanceManager.tag | string | `"1.7.2"` | Tag for the Longhorn Instance Manager image. |
| image.longhorn.manager.registry | string | `"dp.apps.rancher.io"` | Registry for the Longhorn Manager image |
| image.longhorn.manager.repository | string | `"registry.suse.de/home/mbjoerkelund/orchid/containerfile/longhorn-manager"` | Repository for the Longhorn Manager image. |
| image.longhorn.manager.tag | string | `"1.7.2"` | Tag for the Longhorn Manager image. |
| image.longhorn.shareManager.registry | string | `"dp.apps.rancher.io"` | Registry for the Longhorn Share Manager image |
| image.longhorn.shareManager.repository | string | `"registry.suse.de/home/mbjoerkelund/orchid/containerfile/longhorn-share-manager"` | Repository for the Longhorn Share Manager image. |
| image.longhorn.shareManager.tag | string | `"1.7.2"` | Tag for the Longhorn Share Manager image. |
| image.longhorn.supportBundleKit.registry | string | `"dp.apps.rancher.io"` | Registry for the Longhorn Support Bundle Manager image |
| image.longhorn.supportBundleKit.repository | string | `"registry.suse.de/home/mbjoerkelund/orchid/containerfile/rancher-support-bundle-kit"` | Repository for the Longhorn Support Bundle Manager image. |
| image.longhorn.supportBundleKit.tag | string | `"0.0.45"` | Tag for the Longhorn Support Bundle Manager image. |
| image.longhorn.ui.registry | string | `"dp.apps.rancher.io"` | Registry for the Longhorn UI image |
| image.longhorn.ui.repository | string | `"registry.suse.de/home/mbjoerkelund/orchid/containerfile/longhorn-ui"` | Repository for the Longhorn UI image. |
| image.longhorn.ui.tag | string | `"1.7.2"` | Tag for the Longhorn UI image. |
